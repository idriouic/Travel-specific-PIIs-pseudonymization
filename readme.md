...
- **Faker Integration**: Replaces sensitive data with synthetic data, while also providing flexibility for adding custom synthetic data generators (e.g., generating synthetic PNRs, e-tickets).
...
4. **`generators.py`**: Implements custom data generators that create realistic synthetic data for aviation-related entities (e.g., generating synthetic PNRs or e-tickets).
